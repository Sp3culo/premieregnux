...
class InstallationThread(ProcessThread):
    ...
    def symlink_support_files(self):
        ...
        ae_pf_dir = get_wineprefix_dir().joinpath('drive_c/Program Files/Adobe/Adobe Premiere Pro 2023')
    ...
    def unpack_ae(self):
        ...
        self.log_signal.emit('[DEBUG] Searching for Adobe Premiere Pro.exe...')

        for exe_path in root_path.rglob('Adobe Premiere Pro.exe'):
